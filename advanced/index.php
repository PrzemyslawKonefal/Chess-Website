<?php session_start();
$_SESSION['location'] = "advanced/index.php";
?>
!DOCTYPE html>
<html>
  <head>
  ...
  <body>
    ...
    <div class="categories">
        <div class="category beginner">
          <a  style="color:inherit;">Checkmates <br> in 3</a>
          <a class="color beginner" href="Ch3.php"></a>
        </div>
        <div class="category beginner">
          <a  style="color:inherit;">Create <br> Advantage</a>
          <a class="color beginner" href="advantage.php"></a>
        </div>
    </div>
