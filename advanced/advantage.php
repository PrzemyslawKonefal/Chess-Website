<?php session_start();
$_SESSION['location'] = "advanced/advantage.php";
$_SESSION['ID'] = -1;
$_SESSION['movesCounter'] = 0;
$_SESSION['Table'] = "advantage"
 ?>
...
<html>
  ...
  <body>
    ...
    <div class="grid">
        <div class="box">
          <h2 style="text-align:center; color:#d7b62b; text-shadow: 2px 2px #000;">Create Advantage!</h2>
