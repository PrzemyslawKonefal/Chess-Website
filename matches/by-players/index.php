  ...
  <body>
    ...
    <div class="main">
      <div class="container" id="players">
        <a class="player" href="kasparov.php">
          Garry Kasparov
        </a>
        <a class="player" href="carlsen.php">
          Magnus Carlsen
        </a>
        <a class="player" href="fischer.php">
          Bobby Fischer
        </a>
        <a class="player" href="spassky.php">
          Boris Spassky
        </a>
        <a class="player" href="karpov.php">
          Anatoly Karpov
        </a>
        <a class="player" href="anand.php">
          Viswanathan Anand
        </a>
      </div>
    </div>
